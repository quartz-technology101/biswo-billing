            ...
            >
              <div className="flex-1">
                ...
                <div className="flex flex-row w-full justify-between items-center mb-1">
                  <div className="font-title flex-1"> Customer Name </div>
                ...
                <div className="flex flex-row w-full justify-between items-center mb-1">
                  <div className="font-title flex-1"> Customer Number </div>
                  <div className="font-title flex-1 text-right">
                    <input
                      autoComplete="nope"
                ...
                <div className="flex flex-row w-full justify-between items-center mb-1">
                  <div className="font-title flex-1"> Customer Address </div>
                  <div className="font-title flex-1 text-right">
                    <input
                      autoComplete="nope"
